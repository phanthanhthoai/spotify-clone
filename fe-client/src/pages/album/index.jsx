...
import SongInAlbum from "./SongInAlbum.jsx";
...
export default function PlayList() {
    ...
    useEffect(() => {
        const fetchPlaylist = async (code) => {
            const response = await albumService.getAlbumById(code);
                ...
                <div className="h-full w-full">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative p-7">
                            <div className="text-[2rem] font-black text-white">Danh sách bài hát</div>
                            <div className="mt-5">
                                <SongInAlbum album={playlist} />
                            </div>
                        </div>
                    </div>
                </div>
